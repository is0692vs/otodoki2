"""
楽曲データモデル定義
iTunes APIやキューシステムで使用するTrackモデル
"""

from typing import Optional, Union
from pydantic import BaseModel, Field

# DBモデルはdb.modelsからインポート
...
class Track(BaseModel):
    ...
    # Like/Dislike状態
    liked: bool = Field(default=False, description="Like状態")
    disliked: bool = Field(default=False, description="Dislike状態")
